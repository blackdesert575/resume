...
\section{PROJECTS}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem{\textbf{Tech Stack}: LaTeX, pdf2htmlEX, Bash, JavaScript/TypeScript, node.js, React, Next.js, GNU Make, Github, Linux, Docker, Nginx, Cloudflare Workers & Pages}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
